/*!
 ...
 \file      V_fifo.c
 \brief     Кольцевой масcив типа FIFO. Позволяет записывать данные типа "Uint8"
...
struct Sfifo {
	...
	Uint16 wrapFlag;	// Взводится в 1, если wp перешёл за границы буфера;
    ...
    int16 (*put)(Tfifo*, Uint16, Uint16*);
    int16 (*get)(Tfifo*, Uint16, Uint16*);
    int16 (*availSpace)(Tfifo*);
    int16 (*filledSpace)(Tfifo*);
    void (*clear)(Tfifo*);
};

int16 Fifo_Put (volatile struct Sfifo*, Uint16, Uint16*);
int16 Fifo_Get (volatile struct Sfifo*, Uint16, Uint16*);
int16 getFill (Tfifo*);
