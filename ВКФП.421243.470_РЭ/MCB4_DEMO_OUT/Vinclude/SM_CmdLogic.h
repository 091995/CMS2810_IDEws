...
//Для управления контроллером мы используем внешние дискретные входы (см. V_DIO)
#define	STARTBUTTON D_IN1	//Проверка на уставку бита в векторе дискретных входов
#define	STOPBUTTON 	D_IN2	//Проверка на уставку бита в векторе дискретных входов
#define	RESETBUTTON D_IN3	//Проверка на уставку бита в векторе дискретных входов
