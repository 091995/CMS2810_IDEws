...
#define UD_CONTROL_OFF  GpioDataRegs.GPBCLEAR.bit.GPIOB2 = 1;   // операция для выключения
#define UD_CONTROL_ON   GpioDataRegs.GPBSET.bit.GPIOB2 = 1;     // операция для включения
#else
...
#define UD_CONTROL_DEFAULTS {0,UD_CONTROL_STATE_OFF,UD_CONTROL_STATE_OFF,UD_CONTROL_STATE_OFF,\
						0,0,0,\
