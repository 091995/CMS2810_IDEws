...
#define DRV_FAULT   GpioDataRegs.GPDDAT.bit.GPIOD0      //Прием общей аварии
#define DRV_FAULT1	GpioDataRegs.GPDDAT.bit.GPIOD1		//Авария верхнего ключа 0
#define DRV_FAULT2	GpioDataRegs.GPDDAT.bit.GPIOD5	    //Авария верхнего ключа 1
#define DRV_FAULT3	GpioDataRegs.GPDDAT.bit.GPIOD6  	//Авария верхнего ключа 2
#define DRV_FAULT4  GpioDataRegs.GPBDAT.bit.GPIOB14     //Авария нижних ключей

//Для сброса аппаратной аварии в данном контроллере используеется внешний дискретный порт ввода
#define RESET_FAULT_BUTTON	D_IN3
#endif
