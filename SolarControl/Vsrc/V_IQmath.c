...
int Fmax_3(int x1, int x2, int x3);
int Fmin_3(int x1, int x2, int x3);
int __IQsat(int A,int Pos,int Neg);


/* ФункциЯ поиска максимального из трех значений */
int Fmax_3(int x1, int x2, int x3){
	int Tmp;
	Tmp = x1;
	if (x2>Tmp) Tmp = x2;
...
/* ФункциЯ поиска минимального из трех значений */
int Fmin_3(int x1, int x2, int x3){
	int Tmp;
	Tmp = x1;
	if (x2<Tmp) Tmp = x2;
