...
#define INV_STATUS_INIT 0x0
#define INV_STATUS_READY 0x1
#define INV_STATUS_RUNNING 0x2
#define INV_STATUS_FAULT 0x3
#define INV_STATUS_TESTING 0x4
#define INV_STATUS_STOPPED 0x5
#define INV_STATUS_AUTO_SET 0x6
#define INV_STATUS_ALARM 0x8
